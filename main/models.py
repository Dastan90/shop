...
class CategoryManager(models.Manager):
    ...
    CATEGORY_NAME_COUNT_NAME = {
        'Кроссовки': 'shoe__count',
        'Шорты': 'short__count',
        'Майки': 'mikey__count',
        'Футболки': 'shirt__count',
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('shoe', 'short', 'shirt', 'mikey')
...
class Shoe(Product):
    ...
    color = models.CharField(max_length=250, null=True, blank=True, verbose_name='Цвет')
...
class CartProduct(models.Model):
    ...
    def __str__(self):
        return "Продукт: {} (для корзина)".format(self.content_object.title)
...
class Customer(models.Model):
    ...
    phone = models.CharField(max_length=250, verbose_name='Номер телефона', null=True, blank=True)
